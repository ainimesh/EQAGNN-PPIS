...
# Feature_Path_test_new = './Feature/test_120/'
...
# test_120
pdb_ids_test_120, sequences_test_120, labels_test_120, input_files_test_120 = processing_fasta_file(Dataset_Path + 'Test_120.fa')
...
# Load the features from the Features directory
...
#5. psepos - positional encoding features 1D
#6. brot_bert - node feature generated from "protein_bert" model 1024D
...
class ProDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        ######----------------------
        # # Adding new edge features in this as well
        # vectors = coords[edge_index[0]] - coords[edge_index[1]]  # [n_edges, 3] 
        # lengths = torch.linalg.norm(vectors, dim=-1, keepdim=True)  # [n_edges, 1] # this gives us he length of the vectors
